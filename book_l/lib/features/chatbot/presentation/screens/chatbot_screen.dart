...
import '../../domain/usecases/get_respuesta_chatbot_usecase.dart';
...
class _ChatbotScreenState extends State<ChatbotScreen> {
              ...
              children: [
                Expanded(
                  child: ChatbotActionCard(
                    onTap: () => _chatbotController.enviarMensaje('Cómo usar la app'),
                ...
                Expanded(
                  child: ChatbotActionCard(
                    onTap: () => _chatbotController.enviarMensaje('Cómo crear una lección'),
  ...
  Widget _buildChatView() {
    ...
    return ListView.builder(
      ...
      itemCount: messages.length + (_isThinking ? 1 : 0), // +1 para el indicador de "pensando"
