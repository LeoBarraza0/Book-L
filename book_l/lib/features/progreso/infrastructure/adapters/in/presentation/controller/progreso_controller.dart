...
import 'package:book_l/features/progreso/infrastructure/adapters/out/repositories/progreso_repository_impl.dart';
import 'package:book_l/features/progreso/application/usecases/get_progreso_usecase.dart';
import 'package:book_l/features/progreso/application/usecases/actualizar_progreso_usecase.dart';
import 'package:book_l/features/progreso/application/usecases/registrar_evento_usecase.dart';
...
class ProgresoController extends ChangeNotifier {
  ...
  ProgresoController._internal()
      : _getProgresoUseCase = GetProgresoUseCase(ProgresoRepositoryImpl()),
        _actualizarProgresoUseCase =
            ActualizarProgresoUseCase(ProgresoRepositoryImpl()),
        _registrarEventoUseCase =
            RegistrarEventoUseCase(ProgresoRepositoryImpl());
