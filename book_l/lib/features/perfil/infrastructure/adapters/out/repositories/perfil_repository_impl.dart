...
class PerfilRepositoryImpl implements PerfilRepository {
  ...
  int getPublicacionesCount(int idUsuario) {
    return _service.cursos.where((c) => c.idUsuarioFk == idUsuario).length;
  }
  ...
  List<dynamic> getLeccionesDeUsuario(int idUsuario) {
    return _service.lecciones.where((l) => l.idUsuarioFk == idUsuario).toList();
  }

  @override
  List<dynamic> getCursosDeUsuario(int idUsuario) {
    return _service.cursos.where((c) => c.idUsuarioFk == idUsuario).toList();
  }
