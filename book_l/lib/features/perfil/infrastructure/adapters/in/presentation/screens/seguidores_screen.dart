...
class _SeguidoresScreenState extends State<SeguidoresScreen> {
  ...
  Widget _buildSeguidorItem({
    ...
    final usernameStr =
        '@${usuario.nombreCompleto.replaceAll(" ", "").toLowerCase()}';
    final avatar = usuario.avatarUrl ??
        'https://ui-avatars.com/api/?name=${usuario.nombreCompleto}&background=random';
          ...
          children: [
            ...
            ListenableBuilder(
                ...
                builder: (context, _) {
                  ...
                  final isFollowing =
                      PerfilController().isFollowing(myId, usuario.idUsuario);
