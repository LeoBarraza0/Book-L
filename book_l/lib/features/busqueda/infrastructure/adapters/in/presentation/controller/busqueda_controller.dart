...
import 'package:book_l/features/busqueda/domain/models/resultado_busqueda.dart';
import 'package:book_l/features/busqueda/application/ports/out/busqueda_repository.dart';
import 'package:book_l/features/busqueda/infrastructure/adapters/out/repositories/busqueda_repository_impl.dart';
import 'package:book_l/features/auth/infrastructure/adapters/in/presentation/controller/auth_controller.dart';
import 'package:book_l/features/busqueda/application/usecases/buscar_contenido_usecase.dart';
...
class BusquedaController extends ChangeNotifier {
  ...
  BusquedaController._internal()
      : _repository = BusquedaRepositoryImpl(),
        _buscarContenidoUseCase =
            BuscarContenidoUseCase(BusquedaRepositoryImpl()) {
    _cargarHistorial();
  }
