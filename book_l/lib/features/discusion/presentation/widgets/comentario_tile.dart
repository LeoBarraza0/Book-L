                    ...
                    Row(
                      children: [
                        ...
                        ListenableBuilder(
                          ...
                          builder: (context, _) {
                            final liked = widget.ctrl.isLiked(widget.comentario.idComentario);
                            final count = widget.ctrl.likeCount(widget.comentario.idComentario);
                            return GestureDetector(
                              onTap: () => widget.ctrl.toggleLike(widget.comentario.idComentario),
