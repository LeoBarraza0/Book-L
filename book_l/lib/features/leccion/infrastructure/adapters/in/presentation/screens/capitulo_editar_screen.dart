...
import 'package:book_l/features/ejercicio/infrastructure/adapters/in/presentation/screens/crear_ejercicio_screen.dart';
          ...
          Positioned.fill(
            child: ClipRRect(
              ...
              child: Builder(
                builder: (context) {
                  final idLeccion =
                      _capituloActual?.idLeccion ?? widget.idLeccion;
                  String? imagenUrl;
                  if (idLeccion != null) {
