            ...
            slivers: [
              ...
              SliverPersistentHeader(
                ...
                delegate: _SliverAppBarDelegate(
                  minHeight:
                      80.0, // 42 tab height + 24 bottom padding + SafeArea/top padding
                  maxHeight: 80.0,
                  child: Container(
                  ...
                  Row(
                    children: [
                      ListenableBuilder(
                        listenable: _ctrl,
                        builder: (context, _) {
                          final isOwner = _ctrl.state.selected?.idUsuarioFk ==
                      ...
                      ListenableBuilder(
                        ...
                        builder: (context, _) {
                          final isSaved = widget.idCurso != null &&
                              GuardadoController()
                                  .isCursoSaved(widget.idCurso!);
                          return _buildCircularIconButton(
                            isSaved ? Icons.favorite : Icons.favorite_border,
                            () {
                              if (widget.idCurso != null) {
                                GuardadoController()
                                    .toggleSavedCurso(widget.idCurso!);
                              }
                            },
                            color: isSaved
                                ? Colors.redAccent
                      ...
                      ListenableBuilder(
                        ...
                        builder: (context, _) {
                          ...
                          final isOwner = curso != null &&
                              curso.idUsuarioFk == AppSession().usuarioId;
                          if (isOwner || curso == null)
                            return const SizedBox.shrink();
                          return Row(
                            children: [
                              const SizedBox(width: 10),
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListenableBuilder(
                    listenable: _ctrl,
                    builder: (context, _) {
                      final creator = curso != null
                          ? _ctrl.getCreadorSync(curso.idUsuarioFk)
                          : null;
                      return GestureDetector(
                        onTap: () => Navigator.push(
                          context,
                          _slideRoute(
                              PerfilScreen(idUsuario: creator?.idUsuario)),
                        ),
                        child: Row(
                          children: [
                            const CircleAvatar(
              ...
              children: [
                for (final l in lecciones) ...[
                  _buildLeccionCard(
                    ...
                    students:
                        l.estudiantes > 0 ? '${l.estudiantes} est.' : '--',
                    progress: l.progreso,
              ...
              children: [
                if (idLeccion != null)
                  ListenableBuilder(
                    ...
                    builder: (context, _) {
                      final isSaved =
                          GuardadoController().isLeccionSaved(idLeccion);
                      return GestureDetector(
                        onTap: () {
