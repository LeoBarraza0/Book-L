        ...
        Row(
          ...
          children: [
            _buildChartFilterButton(
                'Diarios', PeriodoFiltro.diario, currentFiltro),
            const SizedBox(width: 8),
            _buildChartFilterButton(
                'Semanales', PeriodoFiltro.semanal, currentFiltro),
            const SizedBox(width: 8),
            _buildChartFilterButton(
                'Mensuales', PeriodoFiltro.mensual, currentFiltro),
          ],
        ),
      ],
    );
    ...
    for (int i = 0; i < data.length; i++) {
      ...
      textPainter.paint(
        ...
        Offset(x - (textPainter.width / 2),
            size.height - 18), // Movido mas arriba pq se cortaba
      );
