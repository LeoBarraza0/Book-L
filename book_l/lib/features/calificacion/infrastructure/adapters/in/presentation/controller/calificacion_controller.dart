...
import 'package:book_l/features/calificacion/application/usecases/calificar_leccion_usecase.dart';
import 'package:book_l/features/calificacion/application/usecases/calificar_curso_usecase.dart';
import 'package:book_l/features/calificacion/infrastructure/adapters/out/repositories/calificacion_repository_impl.dart';
import 'calificacion_state.dart';

class CalificacionController extends ChangeNotifier {
  static final CalificacionController _instance =
  ...
  final _calificarLeccion =
      CalificarLeccionUseCase(CalificacionRepositoryImpl());
