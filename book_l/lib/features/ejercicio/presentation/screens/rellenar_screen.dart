...
class _RellenarScreenState extends State<RellenarScreen> {
  ...
  void _setupQuestion() {
    ...
    for (final c in _inputCtrls) { c.dispose(); }
    final pregunta = widget.ejercicio.preguntas[_currentQuestionIndex];
    _inputCtrls = List.generate(pregunta.opciones.length, (_) => TextEditingController());
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            const Icon(Icons.text_fields_rounded, color: Colors.white, size: 42),
                      ...
                      ...List.generate(pregunta.opciones.length, (i) {
                        ...
                        return Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text('Espacio ${i + 1}', style: TextStyle(
                              ...
                              Container(
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(color: borderColor, width: resultado != null ? 2 : 1),
                                  boxShadow: [
                                    BoxShadow(
                              ...
                              if (resultado == false)
                                Padding(
                                  ...
                                  child: Text(
                                    ...
                                    style: const TextStyle(fontFamily: 'Inter', fontSize: 12, color: Color(0xFF4DC130), fontWeight: FontWeight.w600),
                                  ),
                                ),
                            ],
                          ),
                      ...
                      // Feedback
                      if (_hasAnswered) _buildFeedbackBox(allCorrect, pregunta.explicacion),
  ...
  Widget _buildActionButton(bool allCorrect) {
    final canSubmit = !_hasAnswered && _inputCtrls.any((c) => c.text.trim().isNotEmpty);
    return Center(
      child: SizedBox(height: 50, width: MediaQuery.of(context).size.width * 0.70,
        child: ElevatedButton(
          ...
          child: Text(!_hasAnswered ? 'Verificar respuestas'
