...
class _VerdaderoFalsoScreenState extends State<VerdaderoFalsoScreen> {
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            const Icon(Icons.help_outline, color: Colors.white, size: 42),
                      ...
                      // Feedback
                      if (_hasAnswered) _buildFeedbackBox(isCorrect, pregunta.opciones, correctIndex, pregunta.explicacion),
  ...
  Widget _buildOptionButton({
    ...
    final showCorrect = _hasAnswered && widget.ejercicio.preguntas[_currentQuestionIndex].opciones[index].correcta;
    final showWrong = _hasAnswered && isSelected && !widget.ejercicio.preguntas[_currentQuestionIndex].opciones[index].correcta;
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: borderColor, width: isSelected || showCorrect || showWrong ? 2.5 : 1),
          ),
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(icon, size: 40, color: isSelected ? selectedColor : Colors.black38),
  ...
  Widget _buildFeedbackBox(bool isCorrect, List opciones, int correctIndex, String? explicacion) {
      ...
      child: SizedBox(
        ...
        child: ElevatedButton(
          onPressed: _selectedIndex != null ? () {
            if (!_hasAnswered) {
              setState(() { _hasAnswered = true; if (isCorrect) _respuestasCorrectas++; });
            } else {
              if (_currentQuestionIndex < widget.ejercicio.preguntas.length - 1) {
                setState(() { _currentQuestionIndex++; _selectedIndex = null; _hasAnswered = false; });
              } else {
          ...
          style: ElevatedButton.styleFrom(
            backgroundColor: _accentColor, disabledBackgroundColor: Colors.grey.shade400,
            elevation: 0, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30)),
          ),
          child: Text(
            !_hasAnswered ? 'Confirmar respuesta'
