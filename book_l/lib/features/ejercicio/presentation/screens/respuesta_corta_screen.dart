...
class _RespuestaCortaScreenState extends State<RespuestaCortaScreen> {
  ...
  void _verificar() {
    ...
    setState(() { _isCorrect = correct; _hasAnswered = true; });
  }
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            const Icon(Icons.short_text_rounded, color: Colors.white, size: 42),
                      ...
                      Container(
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color: _isCorrect == null
                                ...
                                : (_isCorrect! ? const Color(0xFF4DC130) : const Color(0xFFFF606F)),
                        ...
                        child: TextField(
                          ...
                          maxLines: 3,
                          style: const TextStyle(fontFamily: 'Inter', fontSize: 15, color: Colors.black87),
                          decoration: InputDecoration(
                            ...
                            suffixIcon: _isCorrect != null
                                ? Icon(
                                    ...
                                    color: _isCorrect! ? const Color(0xFF4DC130) : const Color(0xFFFF606F),
                                  )
                                : null,
                          ),
                        ),
                      ...
                      if (_isCorrect == false && pregunta.opciones.isNotEmpty)
                        Padding(
                          ...
                          child: Row(
                            children: [
                              const Icon(Icons.lightbulb_outline, color: Color(0xFF4DC130), size: 18),
                              const SizedBox(width: 6),
                              Expanded(
                                child: Text(
                                  'Respuesta esperada: ${pregunta.opciones.first.contenido}',
                                  style: const TextStyle(fontFamily: 'Inter', fontSize: 13, color: Color(0xFF4DC130), fontWeight: FontWeight.w600),
                                ),
                              ),
                            ],
                          ),
                      ...
                      // Feedback
                      if (_hasAnswered) _buildFeedbackBox(_isCorrect ?? false, pregunta.explicacion),
    ...
    return Center(
      child: SizedBox(height: 50, width: MediaQuery.of(context).size.width * 0.70,
        child: ElevatedButton(
          onPressed: !_hasAnswered ? (canSubmit ? _verificar : null) : _siguiente,
          ...
          child: Text(!_hasAnswered ? 'Verificar respuesta'
