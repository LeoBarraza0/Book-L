                    ...
                    children: [
                      ...
                      ReorderableListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final isCorrectPos =
                              _hasAnswered && originalIdx == index;
                          final isWrongPos =
                              _hasAnswered && originalIdx != index;
                          ...
                          if (isCorrectPos) {
                            tileBg =
                                const Color(0xFF4DC130).withValues(alpha: 0.1);
                            borderCol = const Color(0xFF4DC130);
                          } else if (isWrongPos) {
                            tileBg =
                                const Color(0xFFFF606F).withValues(alpha: 0.1);
                              ...
                              children: [
                                ...
                                if (isCorrectPos)
                                  const Icon(Icons.check_circle,
                                      color: Color(0xFF4DC130), size: 22),
                                if (isWrongPos)
                                  const Icon(Icons.error,
                                      color: Color(0xFFFF606F), size: 22),
                              ],
                            ),
                          );
                        },
                      ...
                      if (_hasAnswered)
                        _buildFeedbackBox(
                            _isCorrectOrder, pregunta.explicacion),
        ...
        child: ElevatedButton(
          onPressed: () {
            if (!_hasAnswered) {
              setState(() {
                _hasAnswered = true;
                if (_isCorrectOrder) _respuestasCorrectas++;
              });
            } else {
